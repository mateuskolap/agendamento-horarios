    ...
    <Modal :id="`${mode}CourseModal`" :is-open="isOpen" :title="modalTitle" size="md" @update:is-open="closeModal">
        <form @submit.prevent="handleSubmit">
            <div class="flex flex-col gap-3">
                ...
                <NSelect v-model:value="form.organization_id" :options="organizationsOptions" filterable placeholder="Selecione a Organização" />
                <NSelect v-model:value="form.coordinator_id" :options="coordinatorsOptions" filterable placeholder="Selecione o Coordenador" />
            </div>
